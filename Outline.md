...
Download KiCAD
Download Inkscape
(optional) Pick some SVGs of interest
##### 20 min talking
...
Edit text
Single-layer import
Import basic Resistor logo (from SVG file)
##### 10 min break

#### Hour 2: Editing graphics in Inkscape
##### 20 min talking
...
Do some editing
Notice colors and layers
##### 10 min break

#### Hour 3: Converting footprints
##### 10 min talking
KiCAD footprints
KiCAD local libraries
PCB fabrication + economics
##### 30 min asynchronous
Place fancy Resistor logo (from footprint library)
Use svg2mod to generate your own footprint
Continue editing your footprint
Iterate
##### 10 min break
